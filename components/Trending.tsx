...
const Trending: FunctionComponent<PropsType> = ({ result }) => {
  return (
    <div className="px-3 py-1 rounded-md">
      <div className="hover:bg-white hover:bg-opacity-[0.03] py-1 cursor-pointer transition duration-200 ease-out flex items-center justify-between">
      ...
      <p className="font-bold">&#x23;{result.tweetText}</p>
